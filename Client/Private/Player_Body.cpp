...
HRESULT Player_Body::Initialize(void* arg)
{
	...
	m_pDissolveTime = CAST(BODY_DESC*)(arg)->pDissolveTime;
...
HRESULT Player_Body::Ready_Components()
{
	...
	CHECK_FAILED(Add_Component(m_iLevel, Proto_Model(L"PlayerBody_Base"), Com_Model, RCAST(Component**)(&m_pModelComVec[0])), E_FAIL);
