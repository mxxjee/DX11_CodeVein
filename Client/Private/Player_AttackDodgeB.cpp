...
Client::Player_AttackDodgeB::Player_AttackDodgeB()
{
}

HRESULT Client::Player_AttackDodgeB::Initialize(GameObject* pOwner, Player_MasterRig* pPlayer_MasterRig)
{
...
void Client::Player_AttackDodgeB::Enter_State()
{
	...
	else
	{
		...
		AnimDesc.eWeaponAction = WEAPON_ANIM_ACTION::ATTACKDODGE_B;
...
void Client::Player_AttackDodgeB::Update_State(_float fTimeDelta)
{
	Player::INPUT_DESC& Desc = m_pPlayer->Get_PlayerInputDesc();
...
void Client::Player_AttackDodgeB::Exit_State()
{
}

Player_AttackDodgeB* Client::Player_AttackDodgeB::Create(GameObject* pOwner, Player_MasterRig* pPlayer_MasterRig)
{
	Player_AttackDodgeB* pInstance = new Player_AttackDodgeB();

	if (FAILED(pInstance->Initialize(pOwner, pPlayer_MasterRig)))
	{
		MSG_BOX("Failed to Created : Player_AttackDodgeB");
...
void Client::Player_AttackDodgeB::Free()
{
	__super::Free();
}
