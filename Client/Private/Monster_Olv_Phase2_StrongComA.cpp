...
Client::Monster_Olv_Phase2_StrongComA::Monster_Olv_Phase2_StrongComA()
{
}

HRESULT Client::Monster_Olv_Phase2_StrongComA::Initialize(GameObject* pOwner, _uint iAnimIdx, _float fSpeed)
{
...
void Client::Monster_Olv_Phase2_StrongComA::Enter_State()
{
...
void Client::Monster_Olv_Phase2_StrongComA::Update_State(_float fTimeDelta)
{
	if (m_pMonster == nullptr) return;
...
void Client::Monster_Olv_Phase2_StrongComA::Exit_State()
{
	if (m_pMonster == nullptr) return;
}

Monster_Olv_Phase2_StrongComA* Client::Monster_Olv_Phase2_StrongComA::Create(GameObject* pOwner, _uint iAnimIdx, _float fSpeed)
{
	Monster_Olv_Phase2_StrongComA* pInstance = new Monster_Olv_Phase2_StrongComA();

	if (FAILED(pInstance->Initialize(pOwner, iAnimIdx, fSpeed)))
	{
		MSG_BOX("Failed to Created : Monster_Olv_Phase2_StrongComA");
...
void Client::Monster_Olv_Phase2_StrongComA::Free()
{
	__super::Free();
}
