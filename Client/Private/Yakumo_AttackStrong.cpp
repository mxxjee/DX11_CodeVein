...
Client::Yakumo_AttackStrong::Yakumo_AttackStrong()
{
}

HRESULT Client::Yakumo_AttackStrong::Initialize(GameObject* pOwner)
{
...
void Client::Yakumo_AttackStrong::Enter_State()
{
	...
	if (iProbabilityablity == 0)
		m_pYakumo->Set_Animation(13, false);
	else if (iProbabilityablity == 1)
		m_pYakumo->Set_Animation(14, false);


	m_pYakumoStatCom->Decrease_Stamina(35.f);
}

void Client::Yakumo_AttackStrong::Update_State(_float fTimeDelta)
{
...
void Client::Yakumo_AttackStrong::Exit_State()
{
	m_pYakumo->Set_ApplyTranslation(true);
}

Yakumo_AttackStrong* Client::Yakumo_AttackStrong::Create(GameObject* pOwner)
{
	Yakumo_AttackStrong* pInstance = new Yakumo_AttackStrong();

	if (FAILED(pInstance->Initialize(pOwner)))
	{
		MSG_BOX("Failed to Created : Yakumo_AttackStrong");
...
void Client::Yakumo_AttackStrong::Free()
{
	__super::Free();
}
