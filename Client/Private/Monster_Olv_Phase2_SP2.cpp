...
Client::Monster_Olv_Phase2_SP2::Monster_Olv_Phase2_SP2()
{
}

HRESULT Client::Monster_Olv_Phase2_SP2::Initialize(GameObject* pOwner, _uint iAnimIdx, _float fSpeed)
{
...
void Client::Monster_Olv_Phase2_SP2::Enter_State()
{
...
void Client::Monster_Olv_Phase2_SP2::Update_State(_float fTimeDelta)
{
	if (m_pMonster == nullptr) return;
...
void Client::Monster_Olv_Phase2_SP2::Exit_State()
{
	if (m_pMonster == nullptr) return;
}

Monster_Olv_Phase2_SP2* Client::Monster_Olv_Phase2_SP2::Create(GameObject* pOwner, _uint iAnimIdx, _float fSpeed)
{
	Monster_Olv_Phase2_SP2* pInstance = new Monster_Olv_Phase2_SP2();

	if (FAILED(pInstance->Initialize(pOwner, iAnimIdx, fSpeed)))
	{
		MSG_BOX("Failed to Created : Monster_Olv_Phase2_SP2");
...
void Client::Monster_Olv_Phase2_SP2::Free()
{
	__super::Free();
}
