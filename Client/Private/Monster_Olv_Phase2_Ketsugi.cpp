...
Client::Monster_Olv_Phase2_Ketsugi::Monster_Olv_Phase2_Ketsugi()
{
}

HRESULT Client::Monster_Olv_Phase2_Ketsugi::Initialize(GameObject* pOwner, _uint iAnimIdx, _float fSpeed)
{
...
void Client::Monster_Olv_Phase2_Ketsugi::Enter_State()
{
...
void Client::Monster_Olv_Phase2_Ketsugi::Update_State(_float fTimeDelta)
{
	if (m_pMonster == nullptr) return;
...
void Client::Monster_Olv_Phase2_Ketsugi::Exit_State()
{
	if (m_pMonster == nullptr) return;
}

Monster_Olv_Phase2_Ketsugi* Client::Monster_Olv_Phase2_Ketsugi::Create(GameObject* pOwner, _uint iAnimIdx, _float fSpeed)
{
	Monster_Olv_Phase2_Ketsugi* pInstance = new Monster_Olv_Phase2_Ketsugi();

	if (FAILED(pInstance->Initialize(pOwner, iAnimIdx, fSpeed)))
	{
		MSG_BOX("Failed to Created : Monster_Olv_Phase2_Ketsugi");
...
void Client::Monster_Olv_Phase2_Ketsugi::Free()
{
	__super::Free();
}
