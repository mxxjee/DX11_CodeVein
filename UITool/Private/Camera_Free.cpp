...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
UITool::Camera_Free::Camera_Free()
{
}

UITool::Camera_Free::Camera_Free(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : Camera(pDevice, pContext)
{
}

UITool::Camera_Free::Camera_Free(const Camera_Free& original)
    : Camera(original)
{
}
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT UITool::Camera_Free::Initialize_Prototype(LEVEL _level)
{
...
HRESULT UITool::Camera_Free::Initialize(void* arg)
{
...
void UITool::Camera_Free::Show_Pos()
{
...
void UITool::Camera_Free::Move(const _float fTimeDelta)
{
...
void UITool::Camera_Free::Lock_Mouse()
{
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int UITool::Camera_Free::Update_Priority(const _float fTimeDelta)
{   
    if (m_bIsActive)
    {
        if (m_bLock)
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int UITool::Camera_Free::Update(const _float fTimeDelta)
{
    return 0;
}

void UITool::Camera_Free::Update_Camera(const _float fTimeDelta)
{
    if (m_bIsActive)
    {
        Bind_PipeLine();
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int UITool::Camera_Free::Update_Late(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT UITool::Camera_Free::Render(const _float fTimeDelta)
{
    return S_OK;
}
/******************************************************* 렌더 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 카메라 제어 함수 ////////////////////////////////////////////////////////
void UITool::Camera_Free::SyncYawPitchFromLook()
{
    _vector vLook = m_pTransformCom->Get_State(DIRECTION::LOOK);
    vLook = XMVector3Normalize(vLook);
    _float3 look;
...
void UITool::Camera_Free::LookAt(const _fvector _targetposition)
{
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Camera_Free* UITool::Camera_Free::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
GameObject* UITool::Camera_Free::Clone(void* pArg)
{
