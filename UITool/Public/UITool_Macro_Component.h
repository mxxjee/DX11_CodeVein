...
#define Proto_VIBuffer(name) L"Prototype_Component_VIBuffer_" name
    ...
    inline const _wstring Proto_Com_Shader_VTXPosColor = L"Prototype_Component_Shader_VtxPosColor";
    ...
    inline const _wstring Proto_Com_Shader_Font = L"Prototype_Component_Shader_Font";
