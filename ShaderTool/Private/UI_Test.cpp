...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
ShaderTool::UI_Test::UI_Test()
{
}

ShaderTool::UI_Test::UI_Test(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: UIObject(pDevice, pContext)
{
}

ShaderTool::UI_Test::UI_Test(const UI_Test& original)
	: UIObject(original)
{
}
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT ShaderTool::UI_Test::Initialize_Prototype(LEVEL _level)
{
...
HRESULT ShaderTool::UI_Test::Initialize(void* arg)
{
...
#pragma endregion
	...
	Add_Component(0, L"Prototype_Component_UI_Image", L"Prototype_Component_UI_Image", RCAST(Component**)(&m_pUIRenderer), &Desc);
...
//////////////////////////////////////////////////////// 컨테이너 추가 함수 ////////////////////////////////////////////////////////
//HRESULT ShaderTool::UI_Test::Ready_Components()
//{
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int ShaderTool::UI_Test::Update_Priority(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int ShaderTool::UI_Test::Update(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int ShaderTool::UI_Test::Update_Late(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT ShaderTool::UI_Test::Render(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 피킹 함수 ////////////////////////////////////////////////////////
void ShaderTool::UI_Test::OnClick()
{
	COUT("**************************클릭*************************");
}
void ShaderTool::UI_Test::OnHover()
{
}
void ShaderTool::UI_Test::OnHoverEnter()
{
	COUT("**************************호버시작*************************");
}
void ShaderTool::UI_Test::OnHoverExit()
{
	COUT("**************************호버끝*************************");
}
/******************************************************* 피킹 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
UI_Test* ShaderTool::UI_Test::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
GameObject* ShaderTool::UI_Test::Clone(void* pArg)
{
