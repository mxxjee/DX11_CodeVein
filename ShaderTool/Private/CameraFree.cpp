...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
ShaderTool::CameraFree::CameraFree()
{
}

ShaderTool::CameraFree::CameraFree(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : Camera(pDevice, pContext)
{
}

ShaderTool::CameraFree::CameraFree(const CameraFree& original)
    : Camera(original)
{
}
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT ShaderTool::CameraFree::Initialize_Prototype(LEVEL _level)
{
...
HRESULT ShaderTool::CameraFree::Initialize(void* arg)
{
    ...
    if (arg == nullptr)
    {
        desc.vEye = _float3(-155.f, 10.85f, 99.78f); //카메라 위치 -155.f, 10.85f, 99.78f ..,.,.-55.83f, 13.51f, -91.21f
        desc.vAt = _float3(-155.f, 10.85f, 109.78f); //바라보는 방향 -155.f, 10.85f, 109.78f ,.,.,-55.83f, 13.51f, -81.21f
...
void ShaderTool::CameraFree::Show_Pos()
{
...
void ShaderTool::CameraFree::Move(const _float fTimeDelta)
{
...
void ShaderTool::CameraFree::Lock_Mouse()
{
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int ShaderTool::CameraFree::Update_Priority(const _float fTimeDelta)
{
    if (m_bIsActive)
    {
        if (m_bLock)
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int ShaderTool::CameraFree::Update(const _float fTimeDelta)
{
    //조명 따라다니기 + 각도
...
void ShaderTool::CameraFree::Update_Camera(const _float fTimeDelta)
{
    if (m_bIsActive)
    {
        Bind_PipeLine();
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int ShaderTool::CameraFree::Update_Late(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT ShaderTool::CameraFree::Render(const _float fTimeDelta)
{
    return S_OK;
}
/******************************************************* 렌더 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
CameraFree* ShaderTool::CameraFree::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
    CameraFree* pInstance = new CameraFree(pDevice, pContext);

    MSG_FAIL(pInstance->Initialize_Prototype(_level), L"CameraFree 원본 생성 실패", L"경고!!!", nullptr);

    return pInstance;
}

GameObject* ShaderTool::CameraFree::Clone(void* pArg)
{
    CameraFree* pInstance = new CameraFree(*this);

    MSG_FAIL(pInstance->Initialize(pArg), L"CameraFree 복사 실패", L"경고!!!", nullptr);
...
//////////////////////////////////////////////////////// 객체 반환 함수 ////////////////////////////////////////////////////////
void ShaderTool::CameraFree::Free()
{
    __super::Free();
}
/******************************************************* 객체 반환 함수 *******************************************************/
