...
Item::Item(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT Item::Initialize_Prototype(LEVEL _level)
{
...
HRESULT Item::Initialize(void* arg)
{
...
//////////////////////////////////////////////////////// 컨테이너 추가 함수 ////////////////////////////////////////////////////////
HRESULT Item::Ready_Components()
{
	Bounding_Sphere::BOUNDSPHERE_DESC ColliderDesc{};
	ColliderDesc.fRadius = 1.5f;
	ColliderDesc.vCenter = _float3(0.f, 0.5f, 0.f);

	CHECK_FAILED(Add_Component(m_iLevel, TEXT("Prototype_Component_Collider_Sphere"),
		TEXT("Com_Collider"), (Component**)&m_pColliderCom, &ColliderDesc), E_FAIL);

	m_pGameInstance->Register_Collider(COLLISION_GROUP::ITEM, m_pColliderCom);

	Add_Shader(L"Prototype_Component_Shader_VTXMesh");
	Add_Model(Proto_Model(L"Item"));
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int Item::Update_Priority(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int Item::Update_Parallel(const _float fTimeDelta)
{
...
_int Item::Update(const _float fTimeDelta)
{
	return 0;
}
/******************************************************* 업데이트 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int Item::Update_Late(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT Item::Render(const _float fTimeDelta)
{
...
HRESULT Item::Render_Shadow(const _float fTimeDelta, _int iCascadeNum)
{
...
ordered_json Item::Get_ExtraData()
{
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Item* Item::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
GameObject* Item::Clone(void* pArg)
{
