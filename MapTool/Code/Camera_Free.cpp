...
CCamera_Free::CCamera_Free(const CCamera_Free& original)
    : Camera(original)
{
}
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT CCamera_Free::Initialize_Prototype(LEVEL _level)
{
...
HRESULT CCamera_Free::Initialize(void* arg)
{
...
void CCamera_Free::Move(const _float fTimeDelta)
{
...
void CCamera_Free::Lock_Mouse()
{
    POINT	ptMouse{ LONG(1600 * 0.5f), LONG(900 * 0.5f) };
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int CCamera_Free::Update_Priority(const _float fTimeDelta)
{
    if (m_bIsActive)
    {
        if (m_bLock)
...
void CCamera_Free::SyncYawPitchFromLook()
{
    _vector vLook = m_pTransformCom->Get_State(DIRECTION::LOOK);
    vLook = XMVector3Normalize(vLook);
    _float3 look;
...
void CCamera_Free::LookAt(const _fvector _targetposition)
{
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int CCamera_Free::Update(const _float fTimeDelta)
{
...
void CCamera_Free::Update_Camera(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int CCamera_Free::Update_Late(const _float fTimeDelta)
{
#ifdef _DEBUG
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT CCamera_Free::Render(const _float fTimeDelta)
{
    return S_OK;
}
/******************************************************* 렌더 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
CCamera_Free* CCamera_Free::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
    CCamera_Free* pInstance = new CCamera_Free(pDevice, pContext);

    MSG_FAIL(pInstance->Initialize_Prototype(_level), L"CCamera_Free 원본 생성 실패", L"경고!!!", nullptr);

    return pInstance;
}

GameObject* CCamera_Free::Clone(void* pArg)
{
    CCamera_Free* pInstance = new CCamera_Free(*this);

    MSG_FAIL(pInstance->Initialize(pArg), L"CCamera_Free 복사 실패", L"경고!!!", nullptr);
