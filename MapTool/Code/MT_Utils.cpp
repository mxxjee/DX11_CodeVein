...
_string CMT_Utils::Get_Current_DateTime()
{
...
HRESULT CMT_Utils::Spawn_Static_Object(GameInstance* pGameInstance, _uint iLevel, const _wstring& wstrProtoTag, const MapObject::MAPOBJECT_DESC& desc)
{
