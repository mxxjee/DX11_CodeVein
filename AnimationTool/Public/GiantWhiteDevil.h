...
class GiantWhiteDevil :
    public Monster
{
private:
	explicit GiantWhiteDevil();
	explicit GiantWhiteDevil(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit GiantWhiteDevil(const GiantWhiteDevil& original);
	virtual ~GiantWhiteDevil();
...
public:
	static GiantWhiteDevil* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level);
