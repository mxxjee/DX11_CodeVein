...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
AnimationTool::Loader::Loader()
{
}

AnimationTool::Loader::Loader(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
...
//////////////////////////////////////////////////////// 이니셜라이즈 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Loader::Initialize(LEVEL _eLevelName)
{
...
HRESULT AnimationTool::Loader::Loading()
{
...
//////////////////////////////////////////////////////// 전역 프로토타입 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Loader::Load_Static()
{
...
#pragma endregion
	...
	SHADERENTRY entryPlayerAnim[7] = {
		{"VS_MAIN", "PS_MAIN"},         // Pass 0 : 일반 그리기
		{"VS_MAIN", "PS_MAIN_SHADOW"},   // Pass 1 : 그림자 그리기
		{"VS_MAIN_NORMAL","PS_MAIN_NORMAL_PBR"},//Pass 2 : 실험중
    ...
    //  m_pGameInstance->LoadSound_AddGroup("A", "A", L"../../Resources/Sounds/A/A/이름.wav");
    //  m_pGameInstance->LoadSound("A", L"../../Resources/Sounds/A/A/이름.wav");
...
#pragma region Sound
    ...
    m_pGameInstance->LoadSound("Hammer_Krush_Dust", L"../../Resources/Sounds/Weapon_Sound/Hammer/Hammer_Krush_Dust.wav");
...
#pragma region Monster_개별전용사운드
//    //  m_pGameInstance->LoadSound_AddGroup("개별명", "그룹명", L"../../Resources/Sounds/Monster/몬스터이름/이름.wav");
//    //  m_pGameInstance->LoadSound("이름", L"../../Resources/Sounds/Monster/몬스터이름/이름.wav");
//    //  m_pGameInstance->LoadSound("ADFAFADSFA", L"../../Resources/Sounds/Monster/MONKEY/ASDFAFDF.wav");
//
...
#pragma endregion
    ...
    m_bIsComplete = true;
    m_bStaticComplete = true;
    //m_bLevelCompleteStatic[_UINT(LEVEL::STATIC)] = true;
    return S_OK;
}
/******************************************************* 전역 프로토타입 *******************************************************/
...
//////////////////////////////////////////////////////// 로고 프로토타입 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Loader::Load_Logo()
{
    ...
    COUT("로고 사운드 로딩중");
    CHECK_FAILED(m_pGameInstance->LoadSound("SoundEventTest", L"../../Resources/Sounds/SoundEventTest.wav"), E_FAIL);
...
//////////////////////////////////////////////////////// 메인 프로토타입 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Loader::Load_Main()
{
    LEVEL level = (LEVEL::MAIN);

    COUT("버퍼 로딩중")
#pragma region EFFECT_BUFFERS
    ...
    if (FAILED(m_pGameInstance->Add_Prototype(_UINT(level), TEXT("Prototype_Component_VIBuffer_Particle_Basic"),
...
#pragma endregion
    ...
    if (FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), TEXT("Prototype_Component_Texture_Effects"),
    ...
    prematrix = XMMatrixIdentity() * XMMatrixScaling(0.01f, 0.01f, 0.01f) * XMMatrixRotationX(XMConvertToRadians(90.f)) * XMMatrixRotationY(XMConvertToRadians(180.f));
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerMasterBone,
     ...
     prematrix = XMMatrixIdentity() * XMMatrixScaling(0.01f, 0.01f, 0.01f);
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerBody_Base,
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerHair_Base,      
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerHead_Base,      
        ...
        //CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerWeapon_BlackBayonet,
        ...
        /* For.Prototype_Component_Model_PlayerWeapon_BlackBayonet */
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerWeapon_BlackGreatSword,
        ...
        /* For.Prototype_Component_Model_PlayerWeapon_BlackBayonet */
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerWeapon_BlackHalberd,
        ...
        /* For.Prototype_Component_Model_PlayerWeapon_BlackBayonet */
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerWeapon_WhiteHammer,
        ...
        /* For.Prototype_Component_Model_PlayerWeapon_BlackBayonet */
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Com_Model_PlayerWeapon_BlackSword,
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Model(L"Slave_Vampire"),
            Model::Create(m_pDevice, m_pContext, MODEL::ANIM, L"../../Resources/Model/Monster/Slave_Vampire/Slave_Vampire.siho", PreMatrix_XY, MODELROLE::STANDALONE)), E_FAIL);
        
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Model(L"Slime_Devil"),
            Model::Create(m_pDevice, m_pContext, MODEL::ANIM, L"../../Resources/Model/Monster/SlimeDevil/SlimeDevil.siho", PreMatrix_XY, MODELROLE::STANDALONE)), E_FAIL);

        prematrix *= XMMatrixRotationX(XMConvertToRadians(180.f));
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(LEVEL::MAIN), Proto_Model(L"SlaveDevil"),
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"WolfGhost"),
            Model::Create(m_pDevice, m_pContext, MODEL::ANIM, L"../../Resources/Model/Monster/WolfGhost/WolfGhost.siho", PreMatrix_XY_PLUS, MODELROLE::STANDALONE)), E_FAIL);
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"GiantVampire"),
            Model::Create(m_pDevice, m_pContext, MODEL::ANIM, L"../../Resources/Model/Monster/GiantVampire/GiantVampire.siho", PreMatrix_XY, MODELROLE::STANDALONE)), E_FAIL);

        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"Yakumo"),
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"Monkey_Devil"),
            Model::Create(m_pDevice, m_pContext, MODEL::ANIM, L"../../Resources/Model/Monster/MonkeyDevil/MonkeyDevil.siho", PreMatrix_XY, MODELROLE::STANDALONE)), E_FAIL);


        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"GiantWhiteDevil"),
            Model::Create(m_pDevice, m_pContext, MODEL::ANIM, L"../../Resources/Model/Monster/GiantWhiteDevil/GiantWhiteDevil.fbx", PreMatrix_XY_PLUS, MODELROLE::STANDALONE)), E_FAIL);


        prematrix = XMMatrixIdentity() * XMMatrixScaling(0.01f, 0.01f, 0.01f);

        //CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"GhostKnight_Halberd"),
        //    Model::Create(m_pDevice, m_pContext, MODEL::NONANIM, L"../../Resources/Model/Monster/Monster_Weapon/GhostHalberd/Ghost_Halbard.siho", prematrix, MODELROLE::STANDALONE, true)), E_FAIL);
        

        prematrix = XMMatrixIdentity() * XMMatrixScaling(0.01f, 0.01f, 0.01f)*XMMatrixRotationX(XMConvertToRadians(90.f));

        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"MilitaryLargeHalberd"),
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"WhiteLargeHalberd"),
            Model::Create(m_pDevice, m_pContext, MODEL::NONANIM, L"../../Resources/Model/Monster/Monster_Weapon/WhiteLargeHalberd/WhiteLargeHalberd.fbx", prematrix, MODELROLE::STANDALONE, true)), E_FAIL);
        ...
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_Model(L"Slave_Sword"),
        ...
        m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"Monster_Weapon_Hammer"),
         ...
         CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"Slime_Devil"),
            Slime_Devil::Create(m_pDevice, m_pContext, level)), E_FAIL);

         CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"Slave_Devil"),
             Slave_Devil::Create(m_pDevice, m_pContext, level)), E_FAIL);

         CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"GhostKnight_Hal"),
             GhostKnight_Hal::Create(m_pDevice, m_pContext, level)), E_FAIL);

         CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"WolfGhost"),
             WolfGhost::Create(m_pDevice, m_pContext, level)), E_FAIL);

         CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"GiantVampire"),
             GiantVampire::Create(m_pDevice, m_pContext, level)), E_FAIL);

         CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"Monkey_Devil"),
             Monkey_Devil::Create(m_pDevice, m_pContext, level)), E_FAIL);
         ...
         CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"GiantWhiteDevil"),
             GiantWhiteDevil::Create(m_pDevice, m_pContext, level)), E_FAIL);

#pragma region EFFECTS_GAMEOBJECT

        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), L"Prototype_GameObject_BasicParticle", BasicParticle::Create(m_pDevice, m_pContext)), E_FAIL);

        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), L"Prototype_GameObject_ParticleSystem", ParticleSystem::Create(m_pDevice, m_pContext)), E_FAIL);

        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), L"Prototype_GameObject_TrailEffect", SwordTrail::Create(m_pDevice, m_pContext)), E_FAIL);

        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), L"Prototype_GameObject_BasicMesh", BasicMesh::Create(m_pDevice, m_pContext)), E_FAIL);

#pragma endregion

        //MILITARY_VAMPIRE_BARK_FightThreat_02_Play (920838628)
        //MILITARY_VAMPIRE_BARK_DAMAGE_REPEL_Play (112240483)
        //MILITARY_VAMPIRE_BARK_DAMAGE_SPECIAL_SUCK_00_Play (1002812516)
        //MILITARY_VAMPIRE_BARK_DAMAGE_SPECIAL_SUCK_01_Play (403965463)
        //m_pGameInstance->LoadSound_AddGroup("TSTDSOLDIER_BARK_ATTACK_JUMP_00_Play_01 (85134309)", "TSTDSOLDIER_BARK_ATTACK_JUMP_00_Play_01", L"../../Resources/Sounds/Monster/TSTDSOLDIER/TSTDSOLDIER_BARK_ATTACK_JUMP_00_Play_01 (85134309).wav");

 /*       m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"Player_Hand"),
            Player_Hand::Create(m_pDevice, m_pContext, level));

        m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject(L"Player_Pants"),
            Player_Pants::Create(m_pDevice, m_pContext, level));*/


        COUT("카메라 로딩중");
        CHECK_FAILED(m_pGameInstance->Add_Prototype(_UINT(level), Proto_GameObject_Camera_Free, Camera_Free::Create(m_pDevice, m_pContext, level)), E_FAIL);

        m_pGameInstance->LoadSoundFolder(L"../../Resources/Sounds/Monster/Attack_Test");
...
//////////////////////////////////////////////////////// 레이스 프로토타입 ////////////////////////////////////////////////////////
void AnimationTool::Loader::Dumping_Time()
{
    Sleep(3000);
}
/******************************************************* 스테이지별 공통 *******************************************************/
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Loader* AnimationTool::Loader::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _eLevelName)
{
...
//////////////////////////////////////////////////////// 객체 반환 함수 ////////////////////////////////////////////////////////
void AnimationTool::Loader::Free()
{
    __super::Free();
