...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
AnimationTool::Camera_Free::Camera_Free()
{
}

AnimationTool::Camera_Free::Camera_Free(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : Camera(pDevice, pContext)
{
}

AnimationTool::Camera_Free::Camera_Free(const Camera_Free& original)
    : Camera(original)
{
}
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Camera_Free::Initialize_Prototype(LEVEL _level)
{
...
HRESULT AnimationTool::Camera_Free::Initialize(void* arg)
{
    ...
    if (arg == nullptr)
    {
        desc.vEye = _float3(0.f, 0.f, -10.f);
        desc.vAt = _float3(0.f, 0.f, 0.f);
        desc.fFov = XMConvertToRadians(45.f);
        desc.fNear = 0.1f;
        desc.fFar = 1500.f;
        desc.fSensor = m_fSensor = 0.2f;
...
void AnimationTool::Camera_Free::Show_Pos()
{
...
void AnimationTool::Camera_Free::Move(const _float fTimeDelta)
{
...
void AnimationTool::Camera_Free::Lock_Mouse()
{
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int AnimationTool::Camera_Free::Update_Priority(const _float fTimeDelta)
{   
    if (m_bIsActive)
    {
        if (m_bLock)
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int AnimationTool::Camera_Free::Update(const _float fTimeDelta)
{
    return 0;
}

void AnimationTool::Camera_Free::Update_Camera(const _float fTimeDelta)
{
    if (m_bIsActive)
    {
        Bind_PipeLine();
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int AnimationTool::Camera_Free::Update_Late(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Camera_Free::Render(const _float fTimeDelta)
{
    return S_OK;
}
/******************************************************* 렌더 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 카메라 제어 함수 ////////////////////////////////////////////////////////
void AnimationTool::Camera_Free::SyncYawPitchFromLook()
{
    _vector vLook = m_pTransformCom->Get_State(DIRECTION::LOOK);
    vLook = XMVector3Normalize(vLook);
    _float3 look;
...
void AnimationTool::Camera_Free::LookAt(const _fvector _targetposition)
{
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Camera_Free* AnimationTool::Camera_Free::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
GameObject* AnimationTool::Camera_Free::Clone(void* pArg)
{
...
//////////////////////////////////////////////////////// 객체 반환 함수 ////////////////////////////////////////////////////////
void AnimationTool::Camera_Free::Free()
{
    __super::Free();
}
/******************************************************* 객체 반환 함수 *******************************************************/
