...
AnimationTool::Slave_Devil::Slave_Devil(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : Monster(pDevice, pContext)
{
}

AnimationTool::Slave_Devil::Slave_Devil(const Slave_Devil& original)
    : Monster(original)
{
}

AnimationTool::Slave_Devil::~Slave_Devil()
{
}
/******************************************************* 생성자, 소멸자 *******************************************************/
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Slave_Devil::Initialize_Prototype(LEVEL _level)
{
...
HRESULT Slave_Devil::Initialize(void* _arg)
{
	...
	CAST(GAMEOBJECT_DESC*)(_arg)->wstrName = L"Slave_Devil" + to_wstring(namenum++);
...
//////////////////////////////////////////////////////// 컨테이너 추가 함수 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Slave_Devil::Ready_Components()
{
	Add_Shader(Proto_Com_Shader_VTXAnimMesh);
	Add_Model(Proto_Model(L"SlaveDevil"));
...
//HRESULT Slave_Devil::Ready_Event()
//{
...
_int Slave_Devil::Update_Parallel(const _float fTimeDelta)
{
	__super::Update_Parallel(fTimeDelta);
	return 0;
}

_int Slave_Devil::Update_Priority(const _float fTimeDelta)
{
	__super::Update_Priority(fTimeDelta);
	return 0;
}

_int Slave_Devil::Update(const _float fTimeDelta)
{
...
void AnimationTool::Slave_Devil::Update_WeaponPosition()
{
...
_int Slave_Devil::Update_Late(const _float fTimeDelta)
{
...
HRESULT Slave_Devil::Render(const _float fTimeDelta)
{
...
HRESULT AnimationTool::Slave_Devil::Render_Shadow(const _float fTimeDelta, _int iCascadeNum)
{
	return S_OK;
}

//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Slave_Devil* AnimationTool::Slave_Devil::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
GameObject* Slave_Devil::Clone(void* pArg)
{
...
//////////////////////////////////////////////////////// 객체 반환 함수 ////////////////////////////////////////////////////////
void AnimationTool::Slave_Devil::Free()
{
...
//////////////////////////////////////////////////////// 바인딩 함수 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Slave_Devil::Bind_ShaderResources()
{
...
HRESULT AnimationTool::Slave_Devil::Ready_PartObjects()
{
