...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
Monkey_Devil::Monkey_Devil(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:Monster(pDevice,pContext)
{
}

Monkey_Devil::Monkey_Devil(const Monkey_Devil& original)
	: Monster(original)
{
}

Monkey_Devil::~Monkey_Devil()
{
}

/******************************************************* 생성자, 소멸자 *******************************************************/

HRESULT Monkey_Devil::Initialize_Prototype(LEVEL _level)
{
...
HRESULT Monkey_Devil::Initialize(void* _arg)
{
	...
	CAST(GAMEOBJECT_DESC*)(_arg)->wstrName = L"Monkey_Devil" + to_wstring(namenum++);
...
//////////////////////////////////////////////////////// 컨테이너 추가 함수 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Monkey_Devil::Ready_Components()
{
	Add_Shader(Proto_Com_Shader_VTXAnimMesh);
	Add_Model(Proto_Model(L"Monkey_Devil"));
...
//HRESULT Monkey_Devil::Ready_Event()
//{
...
_int Monkey_Devil::Update_Parallel(const _float fTimeDelta)
{
	__super::Update_Parallel(fTimeDelta);
	return 0;
}

_int Monkey_Devil::Update_Priority(const _float fTimeDelta)
{
	__super::Update_Priority(fTimeDelta);
	return 0;
}

_int Monkey_Devil::Update(const _float fTimeDelta)
{
...
void AnimationTool::Monkey_Devil::Update_WeaponPosition()
{
...
_int Monkey_Devil::Update_Late(const _float fTimeDelta)
{
...
HRESULT Monkey_Devil::Render(const _float fTimeDelta)
{
...
HRESULT AnimationTool::Monkey_Devil::Render_Shadow(const _float fTimeDelta, _int iCascadeNum)
{
	return S_OK;
}

//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Monkey_Devil* AnimationTool::Monkey_Devil::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
GameObject* Monkey_Devil::Clone(void* pArg)
{
...
//////////////////////////////////////////////////////// 객체 반환 함수 ////////////////////////////////////////////////////////
void  AnimationTool::Monkey_Devil::Free()
{
...
//////////////////////////////////////////////////////// 바인딩 함수 ////////////////////////////////////////////////////////
HRESULT AnimationTool::Monkey_Devil::Bind_ShaderResources()
{
...
HRESULT AnimationTool::Monkey_Devil::Ready_PartObjects()
{
	...
	m_pWeaponBoneMatrix = m_pModelCom->Get_SocketBoneMatrixPtr_Index("RightHandAttach");
