...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
VFXTool::Level_Load::Level_Load()
{
}

VFXTool::Level_Load::Level_Load(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT VFXTool::Level_Load::Initialize(LEVEL _level)
{
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int VFXTool::Level_Load::Update_Priority(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int VFXTool::Level_Load::Update(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int VFXTool::Level_Load::Update_Late(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT VFXTool::Level_Load::Render(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Level_Load* VFXTool::Level_Load::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
void VFXTool::Level_Load::Initialize_Level()
{
