...
HRESULT Player_MasterRig::Initialize(void* arg)
{
	...
	//CHECK_FAILED(m_pModelCom->Register_ReadbackBoneName("RightHandAttachSocket", 1), E_FAIL);
...
_int Player_MasterRig::Update(const _float fTimeDelta)
{
	...
	Character::Update_RootPos(false, pPlayerTrnasformCom);
...
HRESULT Player_MasterRig::Ready_Components()
{
	...
	CHECK_FAILED(Add_Component(m_iLevel, L"Prototype_Component_Model_PlayerMasterBone", Com_Model, RCAST(Component**)(&m_pModelCom)), E_FAIL);
