...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
VFXTool::Camera_Free::Camera_Free()
{
}

VFXTool::Camera_Free::Camera_Free(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : Camera(pDevice, pContext)
{
}

VFXTool::Camera_Free::Camera_Free(const Camera_Free& original)
    : Camera(original)
{
}
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT VFXTool::Camera_Free::Initialize_Prototype(LEVEL _level)
{
...
HRESULT VFXTool::Camera_Free::Initialize(void* arg)
{
    ...
    if (arg == nullptr)
    {
        desc.vEye = _float3(1.5f, 6.f, -6.f);
        desc.vAt = _float3(1.5f, 0.f, 0.f);
...
void VFXTool::Camera_Free::Show_Pos()
{
...
void VFXTool::Camera_Free::Move(const _float fTimeDelta)
{
...
void VFXTool::Camera_Free::Lock_Mouse()
{
...
//////////////////////////////////////////////////////// 최초 업데이트 함수 ////////////////////////////////////////////////////////
_int VFXTool::Camera_Free::Update_Priority(const _float fTimeDelta)
{
    if (m_bIsActive)
    {
        if (m_bLock)
...
//////////////////////////////////////////////////////// 업데이트 함수 ////////////////////////////////////////////////////////
_int VFXTool::Camera_Free::Update(const _float fTimeDelta)
{
    return 0;
}

void VFXTool::Camera_Free::Update_Camera(const _float fTimeDelta)
{
    if(m_bIsActive)
    {
        Bind_PipeLine();
...
//////////////////////////////////////////////////////// 레이트 업데이트 함수 ////////////////////////////////////////////////////////
_int VFXTool::Camera_Free::Update_Late(const _float fTimeDelta)
{
...
//////////////////////////////////////////////////////// 렌더 함수 ////////////////////////////////////////////////////////
HRESULT VFXTool::Camera_Free::Render(const _float fTimeDelta)
{
    return S_OK;
}
/******************************************************* 렌더 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
Camera_Free* VFXTool::Camera_Free::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL _level)
{
...
GameObject* VFXTool::Camera_Free::Clone(void* pArg)
{
