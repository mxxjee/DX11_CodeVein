...
VS_OUT VS_MAIN(VS_IN In)
{
    ...
    float4x4 BoneMatrix = (g_BonesMatrices[In.vBlendIndices.x] * In.vBlendWeights.x)
                        ...
                        + (g_BonesMatrices[In.vBlendIndices.w] * In.vBlendWeights.w)
                        + (g_BonesMatrices[In.vBlendIndices2.x] * In.vBlendWeights2.x)
                        + (g_BonesMatrices[In.vBlendIndices2.y] * In.vBlendWeights2.y)
                        + (g_BonesMatrices[In.vBlendIndices2.z] * In.vBlendWeights2.z)
                        + (g_BonesMatrices[In.vBlendIndices2.w] * In.vBlendWeights2.w);
