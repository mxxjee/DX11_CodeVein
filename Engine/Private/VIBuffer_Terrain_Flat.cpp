...
//////////////////////////////////////////////////////// 생성자, 소멸자 ////////////////////////////////////////////////////////
Engine::VIBuffer_Terrain_Flat::VIBuffer_Terrain_Flat()
{
}

Engine::VIBuffer_Terrain_Flat::VIBuffer_Terrain_Flat(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: VIBuffer(pDevice, pContext)
{
}

Engine::VIBuffer_Terrain_Flat::VIBuffer_Terrain_Flat(const VIBuffer_Terrain_Flat& original)
...
//////////////////////////////////////////////////////// 객체 준비 함수 ////////////////////////////////////////////////////////
HRESULT Engine::VIBuffer_Terrain_Flat::Initialize_Prototype(const _wstring& heightfilepath)
{
    _float Interver = 6.f;
	_ulong dwByte = {};
...
#pragma region VERTEX_BUFFER
	...
	for (_uint z = 0; z < m_iNumVerticesZ; ++z)
	{
		for (_uint x = 0; x < m_iNumVerticesX; ++x)
		{
			...
			m_pVertexPositions[index] = pVertices[index].vPosition = _float3(_float(x) * Interver, 0, _float(z) * Interver);
...
HRESULT Engine::VIBuffer_Terrain_Flat::Initialize(void* arg)
{
	return S_OK;
}
/******************************************************* 객체 준비 함수 *******************************************************/
...
//////////////////////////////////////////////////////// 생성자 호출 함수 ////////////////////////////////////////////////////////
VIBuffer_Terrain_Flat* Engine::VIBuffer_Terrain_Flat::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const _wstring& heightfilepath)
{
	VIBuffer_Terrain_Flat* pInstance = new VIBuffer_Terrain_Flat(pDevice, pContext);

	MSG_FAIL(pInstance->Initialize_Prototype(heightfilepath), L"VIBuffer_Terrain_Flat 생성 실패", L"Caution!!!", nullptr);

	return pInstance;
}

Component* Engine::VIBuffer_Terrain_Flat::Clone(void* arg)
{
	VIBuffer_Terrain_Flat* pInstance = new VIBuffer_Terrain_Flat(*this);

	MSG_FAIL(pInstance->Initialize(arg), L"VIBuffer_Terrain_Flat 복사 실패", L"Caution!!!", nullptr);
...
//////////////////////////////////////////////////////// 객체 반환 함수 ////////////////////////////////////////////////////////
void Engine::VIBuffer_Terrain_Flat::Free()
{
	__super::Free();
}
/******************************************************* 객체 반환 함수 *******************************************************/
